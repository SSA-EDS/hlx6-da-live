 ...
 * Derives upload parent/name from a DA source document URL (same shape as entmseds-da.live getPathDetails).
 */
...
/**
 * @param {string} sourceUrl - e.g. https://admin.entmseds-da.live/source/org/repo/path/doc.html
